...
require(ModelMetrics) # for cross entrop
require(foreign) # for reading in data 
require(rmarkdown)
```
...
```{r eval=FALSE, include=TRUE}
py_install(packages = c("patsy", "numpy", "pandas", "scikit-learn", "doubleml", "econml"))
```
...
```{r}
path <- "~/Desktop/interflex/Replication/"
d<-read.dta(paste0(path,"Data/Vernby_AJPS_2013/AJPSReplicationdata_cleaned.RData"),convert.factor=FALSE)
Y="school_diff" 
D="noncitvotsh" 
X="noncit15" 
