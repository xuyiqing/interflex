...
Load the package as well as the simulated toy datasets (s6~s9) for this tutorial. **s7** is a case of a continuous treatment indicator, **s9** is a case of a discrete treatment indicator.
...
Users can also test for **s7**, which has continuous treatment.
