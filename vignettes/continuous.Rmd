...
library(ggplot2)
ggplot() + 
  geom_point(data = s4,aes(x=group, y = Y, colour = as.factor(D))) + guides(colour=FALSE) 
```
...
s4.kernel <- interflex(Y = "Y", D = "D", X = "X", Z = "Z1", data = s4, 
                       estimator = "kernel", FE = c("group","year"), cl = "group",vartype = 'bootstrap',
